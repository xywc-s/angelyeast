...
export const findEntity = (data = {}) =>
  request.post<any, AngelResponse<SalesOrganization>>('/salesOrganization/findEntity', data)

/**
 * 创建
 */
export const create = (data = {}) =>
  request.post<any, AngelResponse<SalesOrganization>>('/salesOrganization/save', data)

/**
 * 更新
 */
export const update = (data = {}) =>
  request.post<any, AngelResponse<SalesOrganization>>('/salesOrganization/update', data)

/**
 * 删除
 */
export const remove = (data = {}) =>
  request.post<any, AngelResponse<SalesOrganization>>('/salesOrganization/delete', data)
